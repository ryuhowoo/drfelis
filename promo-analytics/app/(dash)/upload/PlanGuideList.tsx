  ...
  return (
    <div className="rounded-2xl card-soft p-5">
      <div className="flex items-start justify-between gap-4">
        ...
        <button
          onClick={load}
          className="shrink-0 rounded-lg border border-line px-3 py-1.5 text-xs text-ink-2 hover:bg-soft"
        >
          새로고침
        </button>
      </div>
            ...
            <tbody>
              {rows.map((r) => (
                <tr
                  ...
                  className="cursor-pointer border-t border-line hover:bg-soft"
                >
                  ...
                  <td className="py-2 pr-3">
                    {r.has_perf ? (
                      ...
                      <span className="text-ink-4">✗ 없음</span>
                    )}
                  </td>
                  <td className="py-2 text-right whitespace-nowrap">
                    ...
                    <button
                      ...
                      className="ml-1.5 rounded-lg border border-line px-2 py-1 text-xs text-ink-2 hover:bg-soft disabled:opacity-40"
                    >
