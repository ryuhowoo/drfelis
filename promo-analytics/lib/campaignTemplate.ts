...
const PLAN_HEADER = ["옵션명", "메인", "예상세트수", "SKU", "세트당수량", "단가", "원가"] as const;
...
export function downloadCampaignTemplate(filename = "새캠페인_플랜_양식.xlsx"): void {
  ...
  const planRows = [
    ...
    ["펠리스샌드 마스터 8.3kg 2팩", "Y", 500, "펠리스샌드 (대용량) 마스터 8.3kg", 2, 24900, 7000],
    ["포캣츄 치킨 4팩", "N", 200, "포캣츄 치킨 56g", 4, 8500, 1200],
